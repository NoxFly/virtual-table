...
const g = class g {
  ...
  editCell(t) {
    ...
    return s instanceof HTMLInputElement ? s.addEventListener("keydown", r) : s instanceof HTMLSelectElement && s.addEventListener("change", n, { once: !0, passive: !0 }), s.addEventListener("blur", n, { once: !0, passive: !0 }), t.$.appendChild(s), s.focus(), this;
  }
  /**
   *
   */
